        ...
        {activeTab === 'signin' ? (
          <form className="mt-8 space-y-6" onSubmit={handleSignIn}>
            ...
            <button
              ...
              disabled={loading}
              className="group relative w-auto mx-auto flex items-center justify-center py-2 px-3 border border-white/20 text-xs font-medium rounded-lg text-white bg-white/10 backdrop-blur-sm hover:bg-white/20 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-white/50 shadow-lg transform transition-all duration-150 hover:shadow-xl hover:-translate-y-0.5"
            >
              {loading ? (
                <span className="flex items-center">
